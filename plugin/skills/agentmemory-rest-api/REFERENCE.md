...
| GET | `/agentmemory/agent-events` |
| POST | `/agentmemory/agent-events` |
| GET | `/agentmemory/audit` |
| GET | `/agentmemory/audit/chain` |
| POST | `/agentmemory/audit/chain/verify` |
...
| POST | `/agentmemory/compliance/soc2-evidence` |
...
| POST | `/agentmemory/governance/deletion-propagation` |
| DELETE | `/agentmemory/governance/memories` |
| POST | `/agentmemory/graph/build` |
| POST | `/agentmemory/graph/dsl` |
...
| POST | `/agentmemory/handoffs/status` |
...
| POST | `/agentmemory/lineage/otel/export` |
| POST | `/agentmemory/lineage/otel/import` |
| GET | `/agentmemory/livez` |
| GET | `/agentmemory/memories` |
| GET | `/agentmemory/memories/:id` |
| GET | `/agentmemory/memory-ledger` |
| POST | `/agentmemory/memory-proposals/apply` |
| POST | `/agentmemory/memory-proposals/approve` |
| POST | `/agentmemory/memory-proposals/create` |
| POST | `/agentmemory/memory-proposals/list` |
| POST | `/agentmemory/memory-proposals/reject` |
| GET | `/agentmemory/memory-review-queue` |
| POST | `/agentmemory/memory/archive` |
| POST | `/agentmemory/memory/create` |
| POST | `/agentmemory/memory/delete` |
| POST | `/agentmemory/memory/expire` |
| GET | `/agentmemory/memory/history` |
| POST | `/agentmemory/memory/history` |
| GET | `/agentmemory/memory/inspect` |
| POST | `/agentmemory/memory/inspect` |
| POST | `/agentmemory/memory/restore` |
| GET | `/agentmemory/memory/today` |
| GET | `/agentmemory/memory/unlinked-mentions` |
| POST | `/agentmemory/memory/update` |
...
| GET | `/agentmemory/rules/resolve` |
| POST | `/agentmemory/rules/resolve` |
| POST | `/agentmemory/search` |
| POST | `/agentmemory/search/explain` |
...
| POST | `/agentmemory/sync/local/apply` |
| POST | `/agentmemory/sync/peer/set-status` |
| POST | `/agentmemory/sync/peers/register` |
| POST | `/agentmemory/sync/plan` |
| POST | `/agentmemory/sync/runs/record` |
| POST | `/agentmemory/sync/status` |
| POST | `/agentmemory/sync/workspaces/register` |
