...
Configuration is read from the environment and from `~/.agentmemory/.env` (no `export` prefix). 113 recognized variables:

- `AGENTMEMORY_AGENT_EVENT_RETENTION_`
...
- `AGENTMEMORY_ALLOW_SELF_APPROVAL`
- `AGENTMEMORY_AUTO_CAPTURE`
- `AGENTMEMORY_AUTO_COMPRESS`
- `AGENTMEMORY_AUTO_INSTALL_ENGINE`
...
- `AGENTMEMORY_COMPRESS_ALLOWED_ROOTS`
...
- `AGENTMEMORY_DEBUG`
- `AGENTMEMORY_DISABLE_FILE_LOCKS`
- `AGENTMEMORY_DOCKER`
...
- `AGENTMEMORY_HOME`
- `AGENTMEMORY_HOOK_DELIVERY_TIMEOUT_MS`
- `AGENTMEMORY_HOOK_OUTBOX_DIR`
- `AGENTMEMORY_HOOK_OUTBOX_MAX_BATCH`
- `AGENTMEMORY_HOOK_RETRY_BASE_MS`
- `AGENTMEMORY_HOOK_RETRY_MAX_MS`
- `AGENTMEMORY_III_CONFIG`
- `AGENTMEMORY_III_SHA256`
- `AGENTMEMORY_III_VERSION`
- `AGENTMEMORY_IMAGE_EMBEDDINGS`
- `AGENTMEMORY_IMAGE_STORE_MAX_BYTES`
- `AGENTMEMORY_INCOGNITO`
- `AGENTMEMORY_INJECT_CONTEXT`
- `AGENTMEMORY_INVOCATION_TIMEOUT_MS`
- `AGENTMEMORY_LANCEDB_PATH`
- `AGENTMEMORY_LLM_FAILED_RETRY_COOLDOWN_MS`
- `AGENTMEMORY_LLM_JOB_MAX_ATTEMPTS`
- `AGENTMEMORY_LLM_STALE_RUNNING_MS`
- `AGENTMEMORY_LLM_TIMEOUT_MS`
- `AGENTMEMORY_LOCK_DIR`
- `AGENTMEMORY_LOCK_STALE_MS`
- `AGENTMEMORY_LOCK_TIMEOUT_MS`
...
- `AGENTMEMORY_REPLAY_IMPORT_ROOTS`
...
- `AGENTMEMORY_RULES_ALLOWED_ROOTS`
