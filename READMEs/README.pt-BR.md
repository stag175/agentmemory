...
- `@agentmemory/mcp` como servidor MCP (faz proxy de todas as 74 tools quando `AGENTMEMORY_URL` aponta para um servidor agentmemory em execução; cai para 7 tools localmente quando não há servidor acessível)
