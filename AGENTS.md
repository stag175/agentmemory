...
This project is indexed by GitNexus as **agentmemory-v2** (8372 symbols, 20790 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
