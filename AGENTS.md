...
This project is indexed by GitNexus as **agentmemory** (8986 symbols, 22544 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
