...
This project is indexed by GitNexus as **agentmemory** (9035 symbols, 22746 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
