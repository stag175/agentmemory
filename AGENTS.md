...
- All tests must pass before PR: `npm test` (1800+ tests)
...
- 74 MCP tools by default (`AGENTMEMORY_TOOLS=core` for the 8-tool lean set)
- 166 REST endpoints
...
This project is indexed by GitNexus as **agentmemory-v2** (8815 symbols, 22090 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/agentmemory-v2/context` | Codebase overview, check index freshness |
| `gitnexus://repo/agentmemory-v2/clusters` | All functional areas |
| `gitnexus://repo/agentmemory-v2/processes` | All execution flows |
| `gitnexus://repo/agentmemory-v2/process/{name}` | Step-by-step execution trace |
